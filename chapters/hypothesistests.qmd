...
- Laden Sie den für [Übung 3](../data/uebung-3.zip) vorbereiteten Ordner herunter. Wählen Sie einen der Datensätze im `wide`-Format. 

- Wie könnte die Forschungsfrage lauten? Was ist die Null- und Alternativhypothese?

- Laden Sie den passenden Datensatz in _JASP_ und schauen Sie ihn an.
...
- Definieren Sie einen _SESOI_ für den Unterschied in den zwei zu vergleichenden Bedingungen. Was ist $\Delta$L, was ist $\Delta$U?
